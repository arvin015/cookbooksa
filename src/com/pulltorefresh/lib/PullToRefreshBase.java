...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public MyOnBorderListener mOnBorderListener;
    public ScrollViewExtend.IScrollViewListener mScrollListener;
    ...
    @Override
    public void setDirectionMode(Mode mode) {
     ...
     */
    @Override
    public void setOnBorderListener(MyOnBorderListener onBorderListener) {
     ...
     */
    @Override
    public void setOnScrollListener(ScrollViewExtend.IScrollViewListener listener) {
        this.mScrollListener = listener;

        ((ScrollViewExtend) mRefreshableView).setListener(mScrollListener);
    }
