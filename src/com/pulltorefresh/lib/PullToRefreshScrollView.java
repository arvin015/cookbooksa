...
public class PullToRefreshScrollView extends PullToRefreshBase<ScrollViewExtend> {
    ...
    @Override
    protected ScrollViewExtend createRefreshableView(Context context, AttributeSet attrs) {
    ...
    @TargetApi(9)
    final class InternalScrollViewSDK9 extends ScrollViewExtend {//arvin edit 为了与ViewPager共存
        ...
        /**
         * arvin edit
         * Sliding change processing
         */
        private void doOnBorderListener() {

            if (mOnBorderListener != null) {

                mOnBorderListener.onScroll();

                if (isReadyForPullStart()) {
                    mOnBorderListener.onScrollToTop();
                } else if (isReadyForPullEnd()) {
                    mOnBorderListener.onScrollToBottom();
                }
            }
        }
