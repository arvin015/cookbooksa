...
public abstract class ImageWorker {
	...
	public void loadImage2(Bitmap bitmap,ImageView imageView)
	{
	...
	private void setImageBitmap(ImageView imageView, Bitmap bitmap) {
		...
		SharedPreferences preferences = mContext.getSharedPreferences("index",
				Activity.MODE_PRIVATE);
		int width = preferences.getInt("width", 0);
		double h = imageView.getDrawable().getIntrinsicHeight();
		double w = imageView.getDrawable().getIntrinsicWidth();
		h = ((width) / w) * h;
		w = width;
//		h = ((width / 2) / w) * h;
//		w = width / 2;
