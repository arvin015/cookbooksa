 ...
 */
public class MapGeocoderHelper {
    ...
    public MapGeocoderHelper(NearbyMapActivity act, AMap aMap) {
                        ...
                        if (regeocodeResult != null && regeocodeResult.getRegeocodeAddress() != null) {
                            ...
                            if (address != null) {
                                ...
                                if (currentLatLng != null) {
                                    MapUtil.addMarker(aMap, currentLatLng,
            ...
            public void onGeocodeSearched(GeocodeResult geocodeResult, int i) {
                switch (i) {
                    case 0:
                        ...
                        Log.d("print", "geocodeResult=" + geocodeResult);
