...
public class Constant {
    ...
    public static String url_deletelovedishbycollectid = httpip + "index.php/Collect/deleteCollectDishByCollectId";
    public static String url_deleteloveuserbycollectid = httpip + "index.php/Collect/deleteCollectUserByCollectId";
